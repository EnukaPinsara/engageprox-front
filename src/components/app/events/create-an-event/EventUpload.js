...
//   return (
//     <Card className="mb-3">
//       <Card.Header as="h5">Event Banner</Card.Header>
//       <Card.Body className="bg-body-tertiary">
//         <div {...getRootProps({ className: 'dropzone-area py-6' })}>
//           <input name="uploadedFiles" {...getInputProps()} />
//           <Flex justifyContent="center">
//             <img src={cloudUpload} alt="" width={25} className="me-2" />
//             <p className="fs-9 mb-0 text-700">Drop your Event Banner here</p>
//           </Flex>
//         </div>
//         <div>
//           {files.map(file => (
...
const EventUpload = ({ setValue }) => {
    ...
    onDrop: acceptedFiles => {
      acceptedFiles.forEach(file => {
        ...
        reader.onload = () => {
          ...
          setValue('eventBanner', base64String);
        };
  ...
  return (
    <Card className="mb-3">
      ...
      <Card.Body className="bg-body-tertiary">
        <div {...getRootProps({ className: 'dropzone-area py-6' })}>
          <input name="eventBanner" {...getInputProps()} />
          <Flex justifyContent="center">
            <img src={cloudUpload} alt="" width={25} className="me-2" />
            <p className="fs-9 mb-0 text-700">Drop your Event Banner here</p>
          </Flex>
          ...
          {files.map(file => (
            ...
            >
              ...
              <Flex justifyContent="between" alignItems="center" className="ms-3 flex-1">
                <div>
                  <h6>{file.path}</h6>
                  <p className="mb-0 fs-10 text-400 line-height-1"><strong>{getSize(file.size)}</strong></p>
                </div>
              </Flex>
              <CardDropdown>
                <div className="py-2">
