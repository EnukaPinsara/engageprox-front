                        ...
                        <FormBody title="Search">
                            <Row>
                                <Col className="mb-3">
                                    ...
                                    <div className="btn-group" role="group" aria-label="Search Criteria">
                                        <Button
                                            variant={searchType === 'eventID' ? 'primary' : 'outline-primary'}
                                            className="me-2"
                                        ...
                                        <Button
                                            variant={searchType === 'eventName' ? 'primary' : 'outline-primary'}
                                            className="me-2"
                                        ...
                                        <Button
                                            variant={searchType === 'eventLocation' ? 'primary' : 'outline-primary'}
                                            className="me-2"
                                ...
                                <Col md="12">
                                    <Form.Group controlId="eventSearch" className='mb-3'>
                                        ...
                                        <Form.Control type="text" placeholder="Enter your search term" />
                                    </Form.Group>
                                </Col>
                                <Col md="12">
                            ...
                            <Row>
                                <Col md="12">
                                    <Form.Group controlId="eventType" className='mb-3'>
                                        ...
                                        <Form.Check type="radio" label="Physical" name="eventType" />
                                    ...
                                    <Form.Group controlId="audienceType" className='mb-3'>
                                        ...
                                        <Form.Control as="select">
                                            <option value="1" default disabled>Select Audience Type</option>
